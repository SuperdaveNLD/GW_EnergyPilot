import "./gw-energy-pilot-v051.js?v=1.0.0-stable1";
...
if (PanelClass && !PanelClass.prototype.__epV100Installed) {
  const previousRender = PanelClass.prototype._render;
  PanelClass.prototype._render = function energyPilotV100StableRender(...args) {
  ...
  PanelClass.prototype.__epV100Installed = true;
}
