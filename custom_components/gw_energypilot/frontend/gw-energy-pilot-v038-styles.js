export function ensureV038Styles(root) {
  ...
  style.textContent = `
    ...
    .ep-v038-profile strong {
      display:block; padding-right:35px; color:#e7f7fc; font-size:10px; font-weight:850;
      line-height:1.25; overflow-wrap:anywhere; hyphens:auto;
    }
    .ep-v038-profile small {
      display:block; margin-top:6px; color:#64869a; font-size:7px; line-height:1.45;
      overflow-wrap:anywhere; hyphens:auto;
    }
    .ep-v038-profile[aria-pressed="true"] small { color:#91b8b6; }
    .ep-v038-badge {
      position:absolute; top:8px; right:8px; color:#70e8c2; font-size:6px; font-weight:900; letter-spacing:.08em;
    }
