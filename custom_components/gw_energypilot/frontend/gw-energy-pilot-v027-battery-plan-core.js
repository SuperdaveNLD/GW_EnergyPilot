import "./gw-energy-pilot-v026-complete.js?v=1.3.0-beta.6";
import {
...
} from "./gw-energy-pilot-v027-battery-plan-data.js?v=1.3.0-beta.6";
import {
  cardBody, ensureStyles, rangeControlHtml, sizeControlHtml,
} from "./gw-energy-pilot-v027-battery-plan-view.js?v=1.3.0-beta.6";
...
function openModal(panel) {
  ...
  backdrop.innerHTML = `<style>
    ...
    .ep-v027-modal .actual-pv{width:18px;height:2px;border-radius:999px;background:#ffe36e}.ep-v027-modal .forecast-pv{width:18px;height:0;border-top:2px dashed #ffe36e}
