...
const TEXT = {
  en: {
    ...
    hybrid2Description: "Planned battery charging with grid import uses mode 2 at the configured maximum power with PV priority. While the EV charges, all other plan steps use mode 8 Hold; without EV, they follow Hybrid. Charging and SOC can exceed the EMHASS forecast and its planned SOC maximum.",
  ...
  nl: {
    ...
    hybrid2Control: "Hybrid 2.0 Beta",
    hybrid2Description: "Geplande batterijlading met netimport gebruikt modus 2 op het ingestelde maximale regelvermogen met PV-voorrang. Tijdens EV-laden gebruiken alle overige planstappen modus 8 Hold; zonder EV volgen ze Hybrid. Lading en SOC kunnen de EMHASS-prognose en het geplande SOC-maximum overschrijden.",
