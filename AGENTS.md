...
```text
v1.1.0 Stable
v1.1.0-beta.1 Published promotion candidate
```
...
## Frontend stability contract (v0.41+, active v1.1.0 stable)
...
- The active v1.1.0 stable telemetry path must not write `scrollTop` or `scrollLeft`, capture touch pointers, cancel native vertical gestures or use a hover/render lock.
