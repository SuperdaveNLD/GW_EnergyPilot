...
GW EnergyPilot exposes administrator configuration inside the built-in dashboard. The active v1.3.0-beta.3 settings chain keeps EnergyPilot, EV, EMHASS, PV and GoodWe ownership separated.
