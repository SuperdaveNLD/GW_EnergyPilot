...
# v1.3.0-beta.8 candidate — House self-consumption during EV charging
...
|---|---|---|---|
| **1.3.0-beta.8** | 2026-09-06 | **Beta** | Candidate: Hybrid 2.0 house self-consumption via a measured EV import reference; planned battery charging watts and protective Hold. |
