...
## Current v1.2.0-beta.7 runtime structure
...
```text
__init__.py             config-entry setup, APIs, v1.2.0-beta.7 panel and v0.44 orchestrator entrypoints
...
v1.2.0-beta.7 uses the final presentation-only beta wrapper and advances one
complete `1.2.0-beta.7-chart-touch1` active-graph cache boundary. The bounded
