...
## Current v1.3.0-beta.2 runtime structure
...
```text
__init__.py             config-entry setup, APIs, v1.3.0-beta.2 panel and v0.44 orchestrator entrypoints
...
v1.3.0-beta.2 uses a presentation-only beta wrapper over the v1.2.0 stable
wrapper and advances one complete `1.3.0-beta.2` active-graph cache boundary. The bounded
