...
class V039ReleaseTests(unittest.TestCase):
    def test_v039_behavior_layer_remains_wired_consistently(self) -> None:
        ...
        if version == "0.39":
        ...
        elif version in {"0.41", "0.42", "0.43", "0.44"}:
            ...
            self.assertIn('import "./gw-energy-pilot-v038.js?v=0.41-stable1"', release)
            self.assertIn('gw-energy-pilot-v038-runtime.js?v=0.41-stable1', v038)
        else:
