...
class V039ReleaseTests(unittest.TestCase):
    def test_v039_behavior_layer_remains_wired_consistently(self) -> None:
        ...
        if version == "0.39":
        ...
        elif version in {"0.41", "0.42", "0.43", "0.44", "0.45", "0.46", "0.47", "0.48"}:
            ...
            if version in {"0.42", "0.43", "0.44", "0.45", "0.46", "0.47", "0.48"}:
                ...
                if version in {"0.43", "0.44", "0.45", "0.46", "0.47", "0.48"}:
                    ...
                    if version in {"0.46", "0.47", "0.48"}:
                        ...
                        self.assertIn(
                            'import "./gw-energy-pilot-v042.js?v=0.47-custom-battery1"',
                            v043,
                        )
                    elif version == "0.45":
                ...
                expected_key = "0.47-custom-battery1" if version in {"0.46", "0.47", "0.48"} else "0.42-emhass1"
                self.assertIn(
            ...
            stable_key = "0.47-custom-battery1" if version in {"0.46", "0.47", "0.48"} else "0.41-stable1"
        ...
        i18n_key = "0.47-custom-battery1" if version in {"0.46", "0.47", "0.48"} else "0.38-i18n1"
