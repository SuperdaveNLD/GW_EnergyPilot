...
class V039ReleaseTests(unittest.TestCase):
    def test_v039_behavior_layer_remains_wired_consistently(self) -> None:
        ...
        if version == "0.39":
        ...
        elif version in {"0.41", "0.42", "0.43", "0.44", "0.45", "0.46", "0.47", "0.48", "0.49"}:
            ...
            if version in {"0.42", "0.43", "0.44", "0.45", "0.46", "0.47", "0.48", "0.49"}:
                v042 = (FRONTEND / "gw-energy-pilot-v042.js").read_text(encoding="utf-8")
                if version in {"0.43", "0.44", "0.45", "0.46", "0.47", "0.48", "0.49"}:
                    v043 = (FRONTEND / "gw-energy-pilot-v043.js").read_text(encoding="utf-8")
                    if version in {"0.46", "0.47", "0.48", "0.49"}:
                        if version in {"0.47", "0.48", "0.49"}:
                            if version in {"0.48", "0.49"}:
                                if version == "0.49":
                        ...
                        self.assertIn(
                            'import "./gw-energy-pilot-v042.js?v=0.49-consolidated1"',
                            v043,
                        )
                    elif version == "0.45":
                ...
                expected_key = "0.49-consolidated1" if version in {"0.46", "0.47", "0.48", "0.49"} else "0.42-emhass1"
                self.assertIn(
            ...
            stable_key = "0.49-consolidated1" if version in {"0.46", "0.47", "0.48", "0.49"} else "0.41-stable1"
        ...
        i18n_key = "0.49-consolidated1" if version in {"0.46", "0.47", "0.48", "0.49"} else "0.38-i18n1"
