...
class FrontendV040RenderSettleTests(unittest.TestCase):
    ...
    def test_v040_remains_a_valid_historical_entrypoint_under_v049(self) -> None:
        ...
        self.assertIn("gw-energy-pilot-v110.js?v=1.2.0-stable1", init)
        ...
        self.assertIn('import "./gw-energy-pilot-v041.js?v=1.2.0-stable1"', settings)
        self.assertIn('import "./gw-energy-pilot-v039.js?v=1.2.0-stable1"', v041)
