...
class FrontendV040RenderSettleTests(unittest.TestCase):
    ...
    def test_v040_remains_a_valid_historical_entrypoint_under_v049(self) -> None:
        ...
        self.assertIn("gw-energy-pilot-v131.js?v=1.3.0-beta.10", init)
        ...
        self.assertIn('import "./gw-energy-pilot-v041.js?v=1.3.0-beta.10"', settings)
        self.assertIn('import "./gw-energy-pilot-v039.js?v=1.3.0-beta.10"', v041)
