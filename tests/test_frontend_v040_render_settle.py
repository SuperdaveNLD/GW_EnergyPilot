...
class FrontendV040RenderSettleTests(unittest.TestCase):
    ...
    def test_v040_remains_a_valid_historical_entrypoint_under_v049(self) -> None:
        ...
        self.assertIn("gw-energy-pilot-v131.js?v=1.3.0-beta.7", init)
        ...
        self.assertIn('import "./gw-energy-pilot-v042.js?v=1.3.0-beta.7"', v043)
        self.assertIn('import "./gw-energy-pilot-v041-emhass-settings.js?v=1.3.0-beta.7"', v042)
        self.assertIn('import "./gw-energy-pilot-v041.js?v=1.3.0-beta.7"', settings)
        self.assertIn('import "./gw-energy-pilot-v039.js?v=1.3.0-beta.7"', v041)
