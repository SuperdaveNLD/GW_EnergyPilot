...
class FrontendV040RenderSettleTests(unittest.TestCase):
    ...
    def test_v040_remains_a_valid_historical_entrypoint_under_v049(self) -> None:
        ...
        self.assertIn("gw-energy-pilot-v101.js?v=1.0.1-beta1", init)
        self.assertIn('import "./gw-energy-pilot-v047.js?v=1.0.1-beta1"', v048)
        self.assertIn('import "./gw-energy-pilot-v046.js?v=1.0.1-beta1"', v047)
        self.assertIn('import "./gw-energy-pilot-v045.js?v=1.0.1-beta1"', v046)
        self.assertIn('import "./gw-energy-pilot-v044.js?v=1.0.1-beta1"', v045)
        self.assertIn(
            'import "./gw-energy-pilot-v043.js?v=1.0.1-beta1"',
            release,
        )
        self.assertIn('import "./gw-energy-pilot-v042.js?v=1.0.1-beta1"', v043)
        self.assertIn('import "./gw-energy-pilot-v041-emhass-settings.js?v=1.0.1-beta1"', v042)
        self.assertIn('import "./gw-energy-pilot-v041.js?v=1.0.1-beta1"', settings)
        self.assertIn('import "./gw-energy-pilot-v039.js?v=1.0.1-beta1"', v041)
