...
class FrontendV040RenderSettleTests(unittest.TestCase):
    ...
    def test_v040_remains_a_valid_historical_entrypoint_under_v049(self) -> None:
        ...
        self.assertIn("gw-energy-pilot-v100.js?v=1.0.0-stable1", init)
        ...
        self.assertIn('import "./gw-energy-pilot-v044.js?v=0.51-h1"', v045)
        self.assertIn(
            'import "./gw-energy-pilot-v043.js?v=0.51-h1"',
            release,
        )
        self.assertIn('import "./gw-energy-pilot-v042.js?v=0.51-h1"', v043)
        self.assertIn('import "./gw-energy-pilot-v041-emhass-settings.js?v=0.51-h1"', v042)
        self.assertIn('import "./gw-energy-pilot-v041.js?v=0.51-h1"', settings)
        self.assertIn('import "./gw-energy-pilot-v039.js?v=0.51-h1"', v041)
