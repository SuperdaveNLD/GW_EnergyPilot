...
class FrontendHoverStabilityTests(unittest.TestCase):
    def test_v038_preserves_only_visual_mouse_hover_across_full_render(self) -> None:
        ...
        if "gw-energy-pilot-v048.js?v=" in init_source:
            ...
            self.assertTrue(any(name in init_source for name in ("gw-energy-pilot-v048.js?v=", "gw-energy-pilot-v047.js?v=", "gw-energy-pilot-v046.js?v=", "gw-energy-pilot-v045.js?v=", "gw-energy-pilot-v042.js?v=", "gw-energy-pilot-v041.js?v=", "gw-energy-pilot-v040.js?v=", "gw-energy-pilot-v039.js?v=", "gw-energy-pilot-v038.js?v=")))
