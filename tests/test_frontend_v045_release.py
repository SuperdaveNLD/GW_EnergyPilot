...
class FrontendV045ReleaseTests(unittest.TestCase):
    def test_v045_remains_in_the_active_v049_chain(self) -> None:
        ...
        self.assertIn(
            "gw-energy-pilot-v101.js?v=1.0.1-beta4", init_source
        )
        self.assertIn('import "./gw-energy-pilot-v047.js?v=1.0.1-beta4"', v048)
        self.assertIn('import "./gw-energy-pilot-v046.js?v=1.0.1-beta4"', active)
        ...
        self.assertIn(
            'import "./gw-energy-pilot-v044.js?v=1.0.1-beta4"', release
        )
