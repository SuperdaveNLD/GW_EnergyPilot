...
CACHE_KEY = "1.2.0-beta.3-load-forecast1"
...
class FrontendV045ReleaseTests(unittest.TestCase):
    def test_v045_remains_in_the_active_v049_chain(self) -> None:
        ...
        self.assertIn('import "./gw-energy-pilot-v046.js?v=1.2.0-beta.3-load-forecast1"', active)
        ...
        self.assertIn(
            'import "./gw-energy-pilot-v044.js?v=1.2.0-beta.3-load-forecast1"', release
        )
